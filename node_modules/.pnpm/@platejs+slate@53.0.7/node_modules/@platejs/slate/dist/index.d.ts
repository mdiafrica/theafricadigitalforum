...
type EditorTransforms<V extends Value = Value> = {
   ...
   */
  setNodesBatch: <N extends DescendantIn<V>>(updates: NodeBatchUpdate<N>[]) => void;
  /**
...
type NodeBatchUpdate<N extends Descendant = Descendant> = {
  at: Path;
...
} & Pick<EditorTransforms<V>, 'addMark' | 'apply' | 'delete' | 'deleteFragment' | 'insertBreak' | 'insertFragment' | 'insertNode' | 'insertNodes' | 'insertSoftBreak' | 'insertText' | 'normalizeNode' | 'removeMark'> & Pick<EditorTransforms<V>, 'insertData' | 'insertFragmentData' | 'insertTextData' | 'setFragmentData'> & Pick<EditorTransforms<V>, 'setNodesBatch' | 'writeHistory'>;
//#endregion
