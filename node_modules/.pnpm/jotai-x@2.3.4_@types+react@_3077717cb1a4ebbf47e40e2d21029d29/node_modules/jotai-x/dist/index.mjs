...
import { atom as atom2, useSetAtom } from "jotai";
...
var createAtomProvider = (storeScope, atoms, options = {}) => {
  ...
  return (_a) => {
    ...
    const [storeState, setStoreState] = React2.useState(
      () => store != null ? store : createStore()
    );
    ...
    return /* @__PURE__ */ React2.createElement(AtomStoreContext.Provider, { value: storeContext }, /* @__PURE__ */ React2.createElement(HydrateAtoms, __spreadValues({ store: resolvedStore, atoms }, props), !!Effect && /* @__PURE__ */ React2.createElement(Effect, null), children));
  };
};
...
var createAtomStore = (initialState, {
  ...
  const useAtomValueWithStore = (atomConfig, store, optionsOrScope, selector = identity, equalityFnOrDeps, deps) => {
    ...
    const selectorAtom = React3.useMemo(
      () => memoizedSelector === identity && !memoizedEqualityFn ? atomConfig : selectAtom(
        atomConfig,
        memoizedSelector,
        memoizedEqualityFn
      ),
