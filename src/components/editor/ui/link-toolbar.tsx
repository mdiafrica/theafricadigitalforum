...
/**
 * Link insert/edit popovers. Positioning comes from @platejs/floating
 * (floating-ui — no Radix); only the chrome is ours.
 */
...
export function LinkFloatingToolbar({
  ...
  const input = (
    <div className="flex w-[min(330px,calc(100vw-2rem))] flex-col" {...inputProps}>
