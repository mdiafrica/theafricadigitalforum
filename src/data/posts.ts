...
export const POSTS: Post[] = [
  {
    id: 1,
    slug: "togo-government-roadmap-2025",
    category: "Digital Policy",
    tag: "Editor's Pick",
    title:
      "Togo's Government Roadmap 2025: How One Nation Is Engineering Africa's Digital Leap",
    excerpt:
    ...
    content: `
      ...
      <blockquote>"Digital transformation is not just about technology—it's about reimagining how government serves its people. We are building a Togo that works for everyone, everywhere."<cite>— Minister Cina Lawson</cite></blockquote>
      ...
      <p>The government's flagship initiative, <strong>« Togo Digital Academy »</strong>, has produced over 10,000 graduates who are now contributing to the country's growing tech ecosystem.</p>
      ...
      <p>As Africa's digital transformation accelerates, Togo is positioning itself as a model for what can be achieved when political will meets strategic investment.</p>
    `,
    author: "ADF Editorial Board",
    authorBio:
      "The Africa Digital Forum Editorial Board brings together experienced journalists, policy analysts, and technology experts to deliver in‑depth coverage of Africa's digital transformation.",
    date: "June 14, 2026",
  ...
  {
    id: 2,
    slug: "securing-the-continent-togo-cybersecurity",
    category: "Cybersecurity",
    tag: "Security",
    title:
      "Securing the Continent: Inside Togo's Bid to Lead Africa's Cybersecurity Governance",
    excerpt:
      "As ransomware attacks on African financial institutions triple year-on-year, Togo's CERT-TG has quietly become a regional model for incident response and cross-border threat sharing. We trace the policy architecture being built in Lomé.",
    content: `
    ...
    author: "Amina Diallo",
    authorBio:
      "Amina Diallo is a cybersecurity journalist covering Africa's digital resilience. She has reported from over 15 countries and advises governments on cyber policy.",
    date: "June 12, 2026",
    readTime: "7 min read",
    image: Image2,
  },
  {
    id: 3,
    slug: "lome-port-tech-corridor",
    category: "Infrastructure",
    tag: "Connectivity",
    title:
      "Beyond Bandwidth: How Lomé's Port-Tech Corridor Is Redefining Logistics on the Gulf of Guinea",
    excerpt:
      "The Port of Lomé — the only natural deep-water port in West Africa — is integrating real-time digital tracking, AI-driven customs clearance, and blockchain-based cargo documentation.",
    content: `
    ...
    author: "Kofi Mensah",
    authorBio:
      "Kofi Mensah is a trade and logistics expert based in Accra. He has worked with the World Bank on trade facilitation projects across West Africa.",
    date: "June 10, 2026",
    readTime: "8 min read",
    image: Image3,
  },
  {
    id: 4,
    slug: "mobile-payments-togo-informal-economy",
    category: "Fintech & Payments",
    tag: "Fintech",
    title:
      "T-Money, Wave & the Next Frontier: Mobile Payments Are Reshaping Togo's Informal Economy",
    excerpt:
      "Over 62% of Togolese adults now use mobile money weekly. This seismic shift is unlocking credit access for market traders, motorcycle taxi operators, and smallholder farmers invisible to traditional banking.",
    content: `
    ...
    authorBio:
      "Jean-Paul Agbeko is a fintech analyst specializing in African mobile money markets. He has worked with major telecom operators and financial institutions.",
    date: "June 8, 2026",
    readTime: "6 min read",
    image: Image4,
  },
  {
    id: 5,
    slug: "afcfta-digital-protocol-lome",
    category: "Trade & AfCFTA",
    tag: "Trade",
    title:
      "The AfCFTA Digital Protocol: Why Lomé's Neutral Ground Is Critical to Ratification",
    excerpt:
      "Negotiations over the AfCFTA's e-commerce annexe have repeatedly stalled on data localisation and cross-border payment standards. Delegates from 14 member states chose Lomé to break the deadlock.",
    content: `
    ...
    author: "Fatou Ndiaye",
    authorBio:
      "Fatou Ndiaye is a trade policy expert focusing on African integration. She has advised governments and international organizations on trade negotiations.",
    date: "June 6, 2026",
    readTime: "9 min read",
    image: Image7,
  },
  {
    id: 6,
    slug: "adf-2026-startup-spotlight",
    category: "Startup Ecosystem",
    tag: "Innovation",
    title:
      "ADF 2026 Spotlight: 8 West African Startups Disrupting Agriculture, Health, and Education",
    excerpt:
      "From Abidjan's edtech unicorns to Accra's precision-farming platforms, this year's ADF Innovation Stage features founders solving the continent's most persistent challenges with homegrown technology.",
    content: `
    ...
    author: "Chioma Obi",
    authorBio:
      "Chioma Obi covers African tech and innovation. She has reported on startup ecosystems across the continent and is a regular contributor to leading tech publications.",
    date: "June 4, 2026",
    readTime: "7 min read",
    image: Image9,
  },
