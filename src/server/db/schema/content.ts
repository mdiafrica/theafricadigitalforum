...
export const event = pgTable(
  ...
  {
    id: uuid("id").primaryKey().defaultRandom(),
    day: text("day").default("").notNull(),
    track: text("track").default("").notNull(),
...
export const eventTranslation = pgTable(
  "event_translation",
  {
    ...
    expectedOutcome: text("expected_outcome").default("").notNull(),
    beneficiaries: text("beneficiaries").default("").notNull(),
    speaker: text("speaker").default("").notNull(),
    dayDescription: text("day_description").default("").notNull(),
